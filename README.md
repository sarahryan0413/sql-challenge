...
It’s been two weeks since I was hired as a new data engineer at Pewlett Hackard (a fictional company). My first major task is a research project on people the company employed during the 1980s and 1990s. The only records left from that period are six CSV files.

For this project, I’ll design tables to store the data from the CSV files, import the data into a SQL database, and then analyze it to answer key questions. This means I’ll be working through data modeling, data engineering, and data analysis.
